  ...
  <tr>
    <td><table width="1000" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="745" align="center" valign="top" bgcolor="#f7e6d4">
          <table width="700" border="1" cellspacing="0" cellpadding="5">
            <tr>
              <td bgcolor="#663300" class="normal2"><strong>วิธีใช้บริการ</strong></td>
            </tr>
            <tr>
              <td bgcolor="#FFFFFF" class="normal">xxx</td>
            </tr>
          </table>
          <p>&nbsp;</p>          
          </td>
